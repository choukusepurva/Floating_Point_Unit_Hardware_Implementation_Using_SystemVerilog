...
# Generated on: Sun Apr 09 18:38:47 IST 2023 (Sun Apr 09 13:08:47 UTC 2023)
...
set_log_file fv/top_FPU/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/top_FPU -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/media/disk1/tools/Cadence/CadenceTools/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/media/disk1/tools/Cadence/CadenceTools/GENUS211/tools.lnx86"
set env(CW_DIR) "/media/disk1/tools/Cadence/CadenceTools/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/media/disk1/tools/Cadence/CadenceTools/GENUS211/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path /media/disk1/tools/Cadence/Cadence_lib/UMC65nm_PDK/STDCELLS/synopsys/ccs/ -library -both
read_library -liberty -both /media/disk1/tools/Cadence/Cadence_lib/UMC65nm_PDK/STDCELLS/synopsys/ccs/uk65lscllmvbbr_120c25_tc_ccs.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../rtl/top_FPU.sv
elaborate_design -golden -root {top_FPU} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/top_FPU/fv_map.v.gz
elaborate_design -revised -root {top_FPU}
...
#add_name_alias fv/top_FPU/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/top_FPU/rtl_to_fv_map.log
}
